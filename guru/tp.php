    ...
    <body>
            ...
            <div id="murid" class="constructor">
                <div class="well well-sm" style="margin-top:5px">
                        <ul class="breadcrumb pull-left" style="margin-bottom:5px; background-color:#fff;">
                            ...
                            <li class="active"><?php echo $pageini; ?></li>
                        </ul>
                        ...
                        <table class="table table-striped table-hover ">
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?php
                                            if ($pdo->query("select count(id_nilai) from nilai_tp where id_murid='".$row[0]."'")->fetchColumn() > 0) {
                                        ?>
                                        <a href="inserttp.php?nisn=<?php echo $row[0]; ?>" class="btn btn-material-indigo btn-xs" style="margin:-6px 0 -5px 0">
                                            <i class="zmdi zmdi-edit"></i> Update Nilai
                                        </a>
                                        <?php
                                            }else{
                                        ?>
                                        <a href="inserttp.php?nisn=<?php echo $row[0]; ?>" class="btn btn-material-teal-A700 btn-xs" style="margin:-6px 0 -5px 0">
        ...
        <script>
            $('#modalupdate').on('show.bs.modal', function (event) {
              ...
              modal.find('.modal-body #iframenya').attr('src', 'inserttp.php?nisn='+nisn)
            })
        </script>
        <script>
            var options = {
